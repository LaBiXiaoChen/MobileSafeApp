package com.demo.safe.homeMain;
...
import com.demo.safe.advanced.AdvancedToolsActivity;
import com.demo.safe.antitheft.LostFindActivity;
import com.demo.safe.antitheft.dialog.InterPasswordDialog;
import com.demo.safe.antitheft.dialog.SetUpPasswordDialog;
import com.demo.safe.antitheft.service.MyDeviceAdminReciever;
import com.demo.safe.antitheft.utils.MD5Utils;
import com.demo.safe.cacheClean.CacheClearListActivity;
import com.demo.safe.emptyFolderCleanup.EmptyMainActivity;
import com.demo.safe.R;
import com.demo.safe.homeMain.view.RoundProgressBar;
import com.demo.safe.processManager.ProcessManagerActivity;
import com.demo.safe.setting.SettingsActivity;
import com.demo.safe.software.AppManagerActivity;
import com.demo.safe.telephoneList.SecurityPhoneActivity;
import com.demo.safe.traffic.TrafficMonitoringActivity;
import com.demo.safe.virusScan.VirusScanActivity;
import com.demo.safe.welcomeView.adapter.HomeAdapter;
...
public class HomeMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((ImageView) findViewById(R.id.imgv_leftbtn)).setVisibility(View.GONE);
    ...
    private void init() {
        ...
        mRoundProgressBar5.setDefaultStr("");
